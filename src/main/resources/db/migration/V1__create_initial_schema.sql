...
CREATE INDEX idx_categories_type_display_order ON categories (type, display_order, id);
...
CREATE INDEX idx_transactions_month_order ON transactions (transaction_date, display_order, id);
